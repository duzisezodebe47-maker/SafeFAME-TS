...
from bundle_reader import (  # noqa: E402
    BundleUnavailable, assert_grid, decision_halves, read_frozen_bundle, segment_bounds,
)
...
def main() -> int:
    ...
    for segment in ("train", "calibration", "decision"):
        assert_grid(bundle, segment, bounds[segment], horizon)
